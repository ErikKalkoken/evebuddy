...
func (eu *EveUniverseService) SectionExists(section model.GeneralSection) (bool, error) {
...
func (eu *EveUniverseService) UpdateSection(ctx context.Context, section model.GeneralSection, forceUpdate bool) (bool, error) {
