...
import (
	...
	"github.com/ErikKalkoken/evebuddy/internal/ui/mailrecipients"
...
func (u *ui) showAddDialog(w fyne.Window, toInput *widget.Entry, characterID int32) {
	...
	entry.OnChanged = func(search string) {
		...
		go func() {
			missingIDs, err := u.sv.Characters.AddEveEntitiesFromCharacterSearchESI(context.Background(), characterID, search)
			if err != nil {
