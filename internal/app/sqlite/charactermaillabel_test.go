...
func TestDeleteObsoleteMailLabels(t *testing.T) {
	...
	t.Run("can delete obsolete mail labels for a character", func(t *testing.T) {
		...
		factory.CreateCharacterMail(sqlite.CreateCharacterMailParams{CharacterID: c1.ID, LabelIDs: []int32{l1.LabelID}})
		c2 := factory.CreateCharacter()
		l2 := factory.CreateCharacterMailLabel(app.CharacterMailLabel{CharacterID: c2.ID})
		factory.CreateCharacterMail(sqlite.CreateCharacterMailParams{CharacterID: c2.ID, LabelIDs: []int32{l2.LabelID}})
		// when
