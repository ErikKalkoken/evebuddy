...
func TestFetchUnreadCounts(t *testing.T) {
	...
	t.Run("can get mail label unread counts", func(t *testing.T) {
		...
		factory.CreateCharacterMail(sqlite.CreateCharacterMailParams{CharacterID: c.ID, LabelIDs: []int32{inbox.LabelID}, IsRead: false})
		factory.CreateCharacterMail(sqlite.CreateCharacterMailParams{CharacterID: c.ID, LabelIDs: []int32{corp.LabelID}, IsRead: true})
		factory.CreateCharacterMail(sqlite.CreateCharacterMailParams{CharacterID: c.ID, LabelIDs: []int32{corp.LabelID}, IsRead: false})
		factory.CreateCharacterMail(sqlite.CreateCharacterMailParams{CharacterID: c.ID, LabelIDs: []int32{corp.LabelID}, IsRead: false})
