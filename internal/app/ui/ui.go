...
func NewBaseUI(args BaseUIParams) *baseUI {
	...
	u.slotsManufacturing = newIndustrySlots(u, app.ManufacturingSlots)
	u.slotsReactions = newIndustrySlots(u, app.ReactionsSlots)
	u.slotsResearch = newIndustrySlots(u, app.ResearchSlots)
