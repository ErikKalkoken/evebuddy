...
func NewAugmentations(u app.UI) *Augmentations {
	a := &Augmentations{
...
func (a *Augmentations) makeImplantList() *widget.List {
	p := theme.Padding()
	l := widget.NewList(
		func() int {
...
func (a *Augmentations) updateImplants() error {
	if !a.u.HasCharacter() {
...
func (a *Augmentations) makeTopText() (string, widget.Importance) {
