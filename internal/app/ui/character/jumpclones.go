...
func NewJumpClones(u app.UI) *JumpClones {
...
func (a *JumpClones) makeTree() *iwidget.Tree[jumpCloneNode] {
	t := iwidget.NewTree(
...
func (a *JumpClones) newTreeData() (*iwidget.TreeData[jumpCloneNode], error) {
...
func (a *JumpClones) ClonesCount() int {
	return len(a.tree.Data().ChildUIDs(""))
}

func (a *JumpClones) StartUpdateTicker() {
