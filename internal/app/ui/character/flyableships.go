...
func NewFlyableShips(u app.UI) *FlyableShips {
	a := &FlyableShips{
...
func (a *FlyableShips) updateEntries() error {
	if !a.u.HasCharacter() {
...
func (a *FlyableShips) makeTopText() (string, widget.Importance, bool, error) {
	if !a.u.HasCharacter() {
