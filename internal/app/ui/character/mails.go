...
func (a *Mails) makeFolderTree() *iwidget.Tree[FolderNode] {
...
func (a *Mails) makeHeaderList() *widget.List {
	l := widget.NewList(
		func() int {
...
func (a *Mails) updateHeaders() (FolderNode, error) {
	ctx := context.TODO()
...
func (a *Mails) makeFolderTopText(f FolderNode) (string, widget.Importance) {
	if !a.u.HasCharacter() {
...
func (a *Mails) onSendMessage(mode app.SendMailMode, mail *app.CharacterMail) {
...
func (a *Mails) makeToolbar() *widget.Toolbar {
...
func (a *Mails) setMail(mailID int32) {
	ctx := context.TODO()
	characterID := a.u.CurrentCharacterID()
	var err error
