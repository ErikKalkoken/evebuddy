...
func NewAssets(u app.UI) *Assets {
...
func (a *Assets) makeLocationsTree() *iwidget.Tree[locationNode] {
...
func (a *Assets) clearAssets() error {
...
func (a *Assets) makeAssetGrid() *widget.GridWrap {
...
func (a *Assets) makeLocationData() (*iwidget.TreeData[locationNode], error) {
...
func (a *Assets) makeTopText(total int) (string, widget.Importance, error) {
...
func (a *Assets) selectLocation(location locationNode) error {
	a.assets = make([]*app.CharacterAsset, 0)
	a.assetGrid.Refresh()
...
func (a *Assets) updateLocationPath(location locationNode) {
