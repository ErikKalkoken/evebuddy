...
func NewSkillCatalogue(u app.UI) *SkillCatalogue {
	a := &SkillCatalogue{
...
func (a *SkillCatalogue) makeGroupsGrid() fyne.CanvasObject {
	length := func() int {
		return len(a.groups)
	}
...
func (a *SkillCatalogue) makeSkillsGrid() fyne.CanvasObject {
	length := func() int {
		return len(a.skills)
	}
	makeCreateItem := func(trunc fyne.TextTruncation) func() fyne.CanvasObject {
...
func (a *SkillCatalogue) makeTopText() (string, widget.Importance, error) {
	if !a.u.HasCharacter() {
...
func (a *SkillCatalogue) updateGroups() error {
	if !a.u.HasCharacter() {
		return nil
	}
