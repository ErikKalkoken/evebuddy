...
func (a *Slots) makeDataTable(headers xwidget.DataColumns[industrySlotRow], makeCell func(col int, r industrySlotRow) []widget.RichTextSegment) *widget.Table {
	w := widget.NewTable(
...
func (a *Slots) fetchData(ctx context.Context, slotType app.IndustryJobType) ([]industrySlotRow, error) {
