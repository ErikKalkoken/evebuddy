...
func (a *Clones) updateRoutes(flag app.RoutePreference) {
	if a.origin == nil {
		return
	}
	for i := range a.rows {
...
func (a *Clones) changeOrigin(w fyne.Window) {
...
func (a *Clones) sortRows(sortCol int) {
	var order sortDir
	if sortCol >= 0 {
...
func (a *Clones) showRoute(r cloneSearchRow) {
