...
func (a *Jobs) CreateRenderer() fyne.WidgetRenderer {
...
func (a *Jobs) makeDataList() *xwidget.StripedList {
...
func (a *Jobs) filterRowsAsync(sortCol int) {
...
func (a *Jobs) fetchCombinedJobs(ctx context.Context) ([]industryJobRow, error) {
...
func (a *Jobs) showIndustryJobWindow(r industryJobRow) {
