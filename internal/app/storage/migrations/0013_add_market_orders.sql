...
CREATE INDEX character_market_orders_idx3 ON character_market_orders (owner_id);
CREATE INDEX character_market_orders_idx4 ON character_market_orders (region_id);
CREATE INDEX character_market_orders_idx5 ON character_market_orders (type_id);
