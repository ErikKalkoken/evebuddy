...
func TestNullTimeFromTime(t *testing.T) {
	t.Run("can convert normal time", func(t *testing.T) {
		...
		xassert.Equal(t, sql.NullTime{Time: t1, Valid: true}, x)
	})
