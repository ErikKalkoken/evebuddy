...
func TestCorporationContract(t *testing.T) {
	...
	t.Run("can create new full", func(t *testing.T) {
		...
		xassert.Equal(t, app.ContractStatusOutstanding, o.Status)
		xassert.Equal(t, app.ContractTypeCourier, o.Type)
		xassert.Equal(t, endLocation.ToShort(), o.EndLocation)
		xassert.Equal(t, startLocation.ToShort(), o.StartLocation)
		xassert.Equal(t, endLocation.SolarSystem.ID, o.EndSolarSystem.ID)
		xassert.Equal(t, endLocation.SolarSystem.Name, o.EndSolarSystem.Name)
		xassert.Equal(t, startLocation.SolarSystem.ID, o.StartSolarSystem.ID)
		xassert.Equal(t, startLocation.SolarSystem.Name, o.StartSolarSystem.Name)
		assert.WithinDuration(t, time.Now().UTC(), o.UpdatedAt, 5*time.Second)
	})
