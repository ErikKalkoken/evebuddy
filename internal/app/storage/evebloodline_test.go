...
func TestEveBloodline(t *testing.T) {
	...
	t.Run("can create new full", func(t *testing.T) {
		...
		xassert.Equal(t, name, eb.Name)
		xassert.Equal(t, race, eb.Race)
		xassert.Equal(t, charisma, eb.Charisma.MustValue())
		xassert.Equal(t, intelligence, eb.Intelligence.MustValue())
		xassert.Equal(t, memory, eb.Memory.MustValue())
		xassert.Equal(t, perception, eb.Perception.MustValue())
		xassert.Equal(t, willpower, eb.Willpower.MustValue())
	})
}
