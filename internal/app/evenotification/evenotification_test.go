...
func TestShouldRenderAllNotifications(t *testing.T) {
	...
	factory.CreateEveEntityCorporation(app.EveEntity{ID: 98464487})
	factory.CreateEveEntityAlliance(app.EveEntity{ID: 99005333})
	factory.CreateEveEntityCharacter(app.EveEntity{ID: 95281762})
	factory.CreateEveSolarSystem(storage.CreateEveSolarSystemParams{ID: 30001725})
