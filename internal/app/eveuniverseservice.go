...
type EveUniverseService interface {
	...
	UpdateAllEveCharactersESI(ctx context.Context) error
	GetCorporationESI(ctx context.Context, corporationID int32) (*EveCorporation, error)
	GetEveDogmaAttribute(ctx context.Context, id int32) (*EveDogmaAttribute, error)
	GetOrCreateEveDogmaAttributeESI(ctx context.Context, id int32) (*EveDogmaAttribute, error)
	...
	GetEveEntity(ctx context.Context, id int32) (*EveEntity, error)
	...
	ToEveEntities(ctx context.Context, ids []int32) (map[int32]*EveEntity, error)
	...
	GetOrCreateEveCategoryESI(ctx context.Context, id int32) (*EveCategory, error)
	GetOrCreateEveGroupESI(ctx context.Context, id int32) (*EveGroup, error)
	GetOrCreateTypeESI(ctx context.Context, id int32) (*EveType, error)
	AddMissingEveTypes(ctx context.Context, ids []int32) error
	UpdateEveCategoryWithChildrenESI(ctx context.Context, categoryID int32) error
	UpdateEveShipSkills(ctx context.Context) error
